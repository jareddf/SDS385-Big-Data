...
\begin{center}
\includegraphics[width=6.5in]{ex02_2c_simple.pdf}
\end{center}

Now I attempt the algorithm for the WDBC data. 

\begin{center}
\includegraphics[width=6.5in]{ex02_2c_wdbc.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=6.5in]{ex02_2c_EMA.pdf}
\end{center}
\color{black}
...
\begin{center}
\includegraphics[width=6.5in]{ex02_2d.pdf}
\end{center}
\color{black}
...
\begin{center}
\includegraphics[width=6.5in]{ex02_2e.pdf}
\end{center}
\color{black}
